...
inlined by the build. Title → Logo replaces it on any drawing.
...
Valves come as they are bought: **flanged over 1 inch, threaded at 1 inch and
under**. A flanged valve is drawn between the pair of weld neck flanges it bolts
to, and those flanges are welded in and counted in the take-off; a small bore
valve is screwed in and takes no welds at all. Either can be overridden on the
valve itself.
